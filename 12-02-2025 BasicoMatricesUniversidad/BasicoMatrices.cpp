...
void resultados();
int totalCalculos = 0; // Para contar cuántas veces se ha calculado
...
int maxVictorias = 0; // Para saber cuántas veces ha ganado la mejor facultad
...
void llamaCiclo()
{
    ...
    string nombreFacultadGanadora1 = "Ingeniería";
...
void resultados()
{
    cout << "Total de cálculos realizados: " << totalCalculos << endl;
